...
def save_captions(args, word_map, hypotheses, references):
    ...
    with open('./predictions/NWPU/' +'Res+trans_NWPU_res.json', 'w') as f:
...
def evaluate_transformer(args,encoder_image,encoder_feat,decoder):
    ...
    print(".......................................................")
    with open('./predictions/NWPU/Res+trans_NWPU.json', 'w') as file:
...
if __name__ == '__main__':
    ...
    filename = "BEST_checkpoint_resnet50_MCCFormers_diff_as_Q_trans16-baseNWPU.pth.tar"
