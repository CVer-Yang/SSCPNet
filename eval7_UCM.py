...
def save_captions(args, word_map, hypotheses, references):
    ...
    with open('./predictions/UCM/' +'SSCPNet_UCM_res.json', 'w') as f:
        json.dump(result_json_file, f)

    with open('./predictions/UCM/' +'SSCPNet_UCM_gts.json', 'w') as f:
...
def evaluate_transformer(args,encoder_image,sem_enhance,spatial_enhance,encoder_feat,decoder):
    ...
    print(".......................................................")
    with open('./predictions/UCM/SSCPNet_UCM.json', 'w') as file:
...
if __name__ == '__main__':
    ...
    filename = 'BEST_checkpoint_resnet50_CVFF_trans17_31UCM.pth.tar'
