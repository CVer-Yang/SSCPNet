...
def save_captions(args, word_map, hypotheses, references):
    ...
    with open('./predictions/Sydney/' +'Res+trans_Sydney_res.json', 'w') as f:
...
def evaluate_transformer(args,encoder_image,encoder_feat,decoder):
    ...
    with torch.no_grad():
        for i, (image_pairs, caps, caplens, allcaps) in enumerate(
            ...
            encoder_out = encoder_feat(imgs_A) # encoder_out: (S, batch, feature_dim)
    ...
    print(".......................................................")
    with open('./predictions/Sydney/Res+trans_Sydney.json', 'w') as file:
...
if __name__ == '__main__':
    ...
    filename = "BEST_checkpoint_resnet50_MCCFormers_diff_as_Q_trans16-baseSydney.pth.tar"
